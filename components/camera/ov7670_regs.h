...
#define GAIN                    0x00 /* AGC 鈥� Gain control gain setting  */
#define BLUE                    0x01 /* AWB 鈥� Blue channel gain setting  */
#define RED                     0x02 /* AWB 鈥� Red channel gain setting   */
#define VREF                    0x03 /* AWB 鈥� Green channel gain setting */
...
#define REG_MIDH                    0x1C  /* Manufacturer ID Byte 鈥� High */
#define REG_MIDL                    0x1D  /* Manufacturer ID Byte 鈥� Low */
